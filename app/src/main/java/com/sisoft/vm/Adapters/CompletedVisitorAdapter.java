...
public class CompletedVisitorAdapter extends RecyclerView.Adapter<CompletedVisitorAdapter.ViewHolder>  {

    private Context context;
    private ArrayList<VisitDetails> visitDetails;

        public CompletedVisitorAdapter(ArrayList<VisitDetails> visitDetails, Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_my_completed,viewGroup,false);
        return new CompletedVisitorAdapter.ViewHolder(view);
    }
